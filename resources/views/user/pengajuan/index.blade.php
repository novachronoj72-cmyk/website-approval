                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- Menampilkan Nama Verifikator --}}
                            <td>
                                {{ $item->verifikasi->verifikator->name ?? '-' }}
                            </td>

                            {{-- Menampilkan Nama Admin Approval --}}
                            <td>
                                {{ $item->approval->admin->name ?? '-' }}
                            </td>
                        ...
                        @empty
                        <tr>
                            {{-- colspan disesuaikan menjadi 8 karena penambahan 2 kolom --}}
